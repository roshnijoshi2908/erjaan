        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-action-ajax-loading-target="invoices-td-container"><i class="sl-icon-settings display-inline-block p-r-5"></i><?php echo e(cleanLang(__('lang.recurring_settings'))); ?></a>
...
<script>
    $("#invoiceDownloadButton").on('click', function(e) {
    e.preventDefault(); 
...
</script><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/bill/components/misc/invoice/actions.blade.php ENDPATH**/ ?>