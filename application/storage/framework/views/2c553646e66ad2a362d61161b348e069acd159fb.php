...
<tr>
    ...
    <!--total-->
    <td class="x-total text-right <?php echo e($bodyClass); ?>"><?php echo e(runtimeNumberFormat($lineitem->lineitem_total)); ?></td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/bill/components/elements/lineitems.blade.php ENDPATH**/ ?>