    ...
    <div class="col-lg-12">
        ...
        <div class="spacer row">
            <div class="col-sm-12 col-lg-8">
                <?php echo e(cleanLang(__('lang.is_this_sales_person'))); ?>

            </div>
            <div class="col-sm-12 col-lg-4">
                <div class="switch  text-right">
                    <label>
                        <input type="checkbox" name="is_this_sales_person" id="is_this_sales_person"
                            class="js-switch-toggle-hidden-content" value="1" <?php echo e(isset($user) && $user->is_this_sales_person == '1' ? 'checked' : ''); ?> data-target="target_revenue_div">
                        <span class="lever switch-col-light-blue"></span>
                    </label>
                </div>
            </div>
        </div>
        <div class="form-group row <?php echo e(isset($user) && $user->is_this_sales_person != '1' ? 'hidden' : ''); ?>" id="target_revenue_div">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.target_revenue'); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="target-revenue" name="target_revenue"
                    value="<?php echo e($user->target_revenue ?? ''); ?>">
            </div>
        </div>
                ...
                <div class="switch  text-right">
                    <label>
                        <input type="checkbox" name="toggle_social_profile" id="toggle_social_profile"
                            class="js-switch-toggle-hidden-content toggle_social_profile" data-target="social_profile_section">
                        <span class="lever switch-col-light-blue"></span>
                    </label>
                </div>
            </div>
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/team/modals/add-edit-inc.blade.php ENDPATH**/ ?>