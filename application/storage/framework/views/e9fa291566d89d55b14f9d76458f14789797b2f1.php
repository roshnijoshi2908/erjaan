            ...
            <div class="r-panel-body">
                    ...
                    <div class="fields mt-2">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="logo_1" class="w-100 mb-1" value="<?php echo e($invoice['logo'] ?? ''); ?>"style="border: 1px solid #767676; padding: 3px; border-radius: 3px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="filter-block">
                    ...
                    <div class="fields mt-2">
                        <div class="row">
                            <div class="col-md-12">
                                <input type="color" name="color_code" class="w-100 mb-1" value="<?php echo e($invoice['color_code']?? ''); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="filter-block">
                    ...
                    <div class="fields my-2">
                        <div class="row">
                            <div class="col-md-12">
                                <input type="color" name="text_color_code" class="w-100 mb-1" value="<?php echo e($invoice['text_color_code'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger apply-setting-invoice" data-url="<?php echo e(urlResource('/invoices/invoice-settings')); ?>" data-type="form" data-ajax-type="POST"><?php echo e(cleanLang(__('lang.apply'))); ?></button>
                </div>
            </div>
            <!--body-->
        </div>
...
<!--sidebar--><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/invoices/components/misc/setting-invoice.blade.php ENDPATH**/ ?>