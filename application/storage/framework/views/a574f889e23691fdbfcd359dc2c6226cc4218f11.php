...
<div class="kanban-card show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    ...
    <div class="x-title wordwrap" id="kanban_lead_title_<?php echo e($lead->lead_id); ?>"><?php echo e($lead->lead_title); ?> 
       <?php if($lead->actionTaken === 1 && $lead->lead_updated < now()->subDays(2) && $lead->lead_converted == 'no'): ?>
            <span class="alert alert-warning" style="display: inline-flex; align-items: center; margin-left: 10px; background-color: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; padding: 3px; border-radius: 3px; font-size: 0.8em;">
                <i class="mdi mdi-alert-circle" style="margin-right: 5px;"></i>
                <?php echo app('translator')->get('lang.take_action'); ?>
            </span>
        <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/leads/components/kanban/card.blade.php ENDPATH**/ ?>