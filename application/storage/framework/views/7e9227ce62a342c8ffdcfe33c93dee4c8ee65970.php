...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <!--proposals table-->
            <form class="form" id="settingsFormGeneral" action="<?php echo e(route('supplier.store')); ?>" method="post">
    <!--product purchase code-->
<?php echo csrf_field(); ?>
   <div class="form-group row">
        <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.supplier_name'))); ?></label>
        <div class="col-12">
   ...
   <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.supplier_address'))); ?></label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.supplier_telephone'))); ?></label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.supplier_category'))); ?></label>
        <div class="col-12">
             <select class="select2-basic-with-search form-control form-control-sm" data-allow-clear="false"
                ...
                <option value="<?php echo e($category->supplier_category_id); ?>">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.supplier_contact_person_name'))); ?></label>
        <div class="col-12">
     ...
     <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.supplier_contact_person_mobile'))); ?></label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.supplier_created_date'))); ?></label>
        <div class="col-12">
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/supplier/supplier/supplierCreate.blade.php ENDPATH**/ ?>