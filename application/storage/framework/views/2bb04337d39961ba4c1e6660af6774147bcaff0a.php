...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <?php if(!request()->has('filter_phone')): ?>
   ...
   <?php if(request()->has('filter_phone') && request('filter_phone') !== null): ?> 
     <div id="list-page-actions">
          <a href="<?php echo e(url('/leads?toggle=layout')); ?>" class="list-actions-button btn btn-page-actions waves-effect waves-dark">
              <i class="ti-back-right text-primary"></i>
            </a>
         <!--SHOW ARCHIVED LEADS-->
            <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_leads'))); ?>"
                id="pref_filter_show_archived_leads"
...
<script>
// document.getElementById('pref_view_leads_layout').addEventListener('click', function() {
//   $(document).one('ajaxComplete', function(event, xhr, settings) {
//         if (settings.url.includes('/leads/search?action=search&toggle=layout')) {
...
<?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/leads/components/misc/list-page-actions.blade.php ENDPATH**/ ?>