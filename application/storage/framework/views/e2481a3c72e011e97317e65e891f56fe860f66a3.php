    ...
    <div class="col-lg-12">
        ...
        <div id="add_payment_additional_settings" class="hidden">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <textarea class="form-control" name="payment_notes" id="payment_notes" rows="5"><?php echo _clean($payment->payment_notes); ?></textarea>
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/payments/components/modals/edit-payment.blade.php ENDPATH**/ ?>