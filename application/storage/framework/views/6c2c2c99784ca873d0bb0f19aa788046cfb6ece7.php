<div class="row" id="js-trigger-expenses" data-client-id="<?php echo e($expense->expense_clientid ?? ''); ?>"
    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label  required"><?php echo e(cleanLang(__('lang.purchase_request'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="expense_purchaseid"
                    name="expense_purchaseid">
                    <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($purchase->purchase_id); ?>"
                        <?php echo e(runtimePreselected($expense->expense_purchase_id ?? '', $purchase->purchase_id)); ?>><?php echo e(runtimeLang($purchase->purchase_items_list)); ?> </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/expenses/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>