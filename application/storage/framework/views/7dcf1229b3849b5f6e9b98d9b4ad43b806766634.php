...
<!--purchase gm-->
<?php if($event->event_parent_type == 'purchase_gm_approver'): ?>
<div class="x-reference">
        <a href="<?php echo e(_url('gm-approvals')); ?>">
                (<?php echo e(runtimeLang($event->event_parent_title)); ?>

                #<?php echo e($event->event_parent_id); ?>) </a></div>
<?php endif; ?>

<!--purchase accountant-->
<?php if($event->event_parent_type == 'purchase_accountant'): ?>
<div class="x-reference">
...
<!--general expence gm-->
<?php if($event->event_parent_type == 'general_expence_gm_approver'): ?>
<div class="x-reference">
        <a href="<?php echo e(_url('general-expense/gm-approvals')); ?>">
                (<?php echo e(runtimeLang($event->event_parent_title)); ?>
...
<?php if($event->event_parent_type == 'general_expence_accountant'): ?>
<div class="x-reference">
        <a href="<?php echo e(_url('general-expense/accountant')); ?>">
                (<?php echo e(runtimeLang($event->event_parent_title)); ?>

                #<?php echo e($event->event_parent_id); ?>)</a></div>
<?php endif; ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/events/includes/parent.blade.php ENDPATH**/ ?>