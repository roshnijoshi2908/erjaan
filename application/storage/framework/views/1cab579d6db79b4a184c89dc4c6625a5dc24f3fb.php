...
<div class="col-sm-12 col-md-4 col-lg-3 click-url" id="project_<?php echo e($project->project_id); ?>" data-url="<?php echo e(url('/projects/'.$project->project_id)); ?>">
    ...
    <div class="grid-card m-b-35">
        ...
        <div class="grid-card-img-container" <?php echo getCoverImage($project->project_cover_directory ?? '', $project->project_cover_filename ?? ''); ?>>
        </div>
        <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/projects/views/cards/layout/ajax.blade.php ENDPATH**/ ?>