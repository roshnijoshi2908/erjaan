<?php
    $kanban_lead_id = request()->has('kanban_lead_id') ? request('kanban_lead_id') : null;
?>
        ...
        <div class="board-heading clearfix">
            ...
            <div class="pull-right x-action-icons">
                ...
                <span class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form cursor-pointer"
                    ...
                    data-url="<?php echo e(urlResource('/leads/create?status='.$board['id'].'&kanban_lead_id='.$kanban_lead_id)); ?>"
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/leads/components/kanban/board.blade.php ENDPATH**/ ?>