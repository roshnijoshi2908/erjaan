...
<div class="display-flex flex-row comment-row" id="card_comment_<?php echo e($comment->comment_id); ?>">
    ...
    <div class="comment-text w-100 js-hover-actions">
        ...
        <div class="p-t-4"><?php echo _clean($comment->comment_text); ?></div>
    </div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/task/components/comment.blade.php ENDPATH**/ ?>