...
<?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <div class="form-data-row">
        ...
        <span class="x-data-content <?php echo e($field->customfields_datatype); ?>"><?php echo _clean(customFieldValueDisplay($field->customfields_name, $lead, $field->customfields_datatype)); ?></span>
...
<?php endif; ?>
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/lead/content/customfields/show.blade.php ENDPATH**/ ?>