            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_date_format"
                        ...
                        <option value="d-m-Y"
                            <?php echo e(runtimePreselected('d-m-Y', $defaults->defaults_date_format ?? '')); ?>>
                            d-m-Y</option>
                        <option value="d/m/Y"
                            <?php echo e(runtimePreselected('d/m/Y', $defaults->defaults_date_format ?? '')); ?>>
                            d/m/Y</option>
                        <option value="m-d-Y"
                            <?php echo e(runtimePreselected('m-d-Y', $defaults->defaults_date_format ?? '')); ?>>
                            m-d-Y</option>
                        <option value="m/d/Y"
                            <?php echo e(runtimePreselected('m/d/Y', $defaults->defaults_date_format ?? '')); ?>>
                            m/d/Y</option>
                        <option value="Y-m-d"
                            <?php echo e(runtimePreselected('Y-m-d', $defaults->defaults_date_format ?? '')); ?>>
                            Y-m-d</option>
                        <option value="Y/m/d"
                            <?php echo e(runtimePreselected('Y/m/d', $defaults->defaults_date_format ?? '')); ?>>
                            Y/m/d</option>
                        <option value="Y-d-m"
                            <?php echo e(runtimePreselected('Y-d-m', $defaults->defaults_date_format ?? '')); ?>>
                            Y-d-m</option>
                        <option value="Y/d/m"
                            <?php echo e(runtimePreselected('Y/d/m', $defaults->defaults_date_format ?? '')); ?>>
                            Y/d/m</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    ...
                    <select class="select2-basic form-control form-control-sm select2-preselected"
                        id="defaults_currency_code"
                        data-preselected="<?php echo e($defaults->defaults_currency_code ?? ''); ?>"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/landlord/settings/sections/defaults/page.blade.php ENDPATH**/ ?>