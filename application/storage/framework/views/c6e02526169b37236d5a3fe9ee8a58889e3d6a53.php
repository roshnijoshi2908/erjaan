            ...
            <table id="leads-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        <th class="col_lead_value <?php echo e(config('table.tableconfig_column_4')); ?> tableconfig_column_4">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_lead_value" href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/leads?action=sort&orderby=lead_value&sortorder=asc')); ?>">
                                   <?php echo app('translator')->get('lang.converted'); ?> <?php echo app('translator')->get('lang.leads'); ?>
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/leads/components/table/table.blade.php ENDPATH**/ ?>