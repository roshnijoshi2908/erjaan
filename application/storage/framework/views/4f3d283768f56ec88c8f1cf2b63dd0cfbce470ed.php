<div class="row client-details" id="client-details-container">
    <div class="col-sm-12 tinymce-transparent">
        ...
        <div class="client-description p-0 rich-text-formatting" id="client-description"> <?php echo _clean($client->client_description); ?>
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/client/components/tabs/details.blade.php ENDPATH**/ ?>