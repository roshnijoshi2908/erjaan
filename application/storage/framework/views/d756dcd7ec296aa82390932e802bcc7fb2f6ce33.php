...
<tr id="lead_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_value <?php echo e(config('table.tableconfig_column_4')); ?> tableconfig_column_4" id="leads_col_value_<?php echo e($lead->lead_id); ?>">
        <?php echo e(runtimeMoneyFormat($lead->total_non_converted_lead_value)); ?>

    </td>
    
    <!--tableconfig_column_5 [sum of lead converted]-->
    <td class="col_lead_value <?php echo e(config('table.tableconfig_column_4')); ?> tableconfig_column_4" id="leads_col_value_<?php echo e($lead->lead_id); ?>">
        <?php echo e(runtimeMoneyFormat($lead->total_converted_lead_value)); ?>
    ...
    <td class="leads_col_action actions_column" id="leads_col_action_<?php echo e($lead->lead_id); ?>">
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <!--<button type="button" title="<?php echo e(cleanLang(__('lang.all_leads'))); ?>" class="data-toggle-action-tooltip btn btn-outline-success btn-circle btn-sm" data-loading-target="main-top-nav-bar">-->
        ...
        <!--    data-url="<?php echo e(urlResource('/leads/search?action=search&toggle=layout&filter_phone=' . $lead->lead_phone . '&kanban_lead_id=' .$lead->lead_id)); ?>">-->
        <!--    <i class="sl-icon-list"></i>-->
        <!--</button>-->

        <a href="<?php echo e(urlResource('/leads/group-leads?&toggle=layout&filter_phone=' . $lead->lead_phone . '&kanban_lead_id=' .$lead->lead_id)); ?>" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.kanban_view'))); ?>"
            id="kjt"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/leads/components/table/ajax.blade.php ENDPATH**/ ?>