    ...
    <div class="form-group row m-b-0">
        ...
        <div class="col-12">
            <select name="customfields_datapayload[<?php echo e($field->customfields_id); ?>]" id="customfields_datapayload[<?php echo e($field->customfields_id); ?>]"
                ...
                <?php echo _clean(runtimeCustomFieldsJsonLists($field->customfields_datapayload, true)); ?>

            </select>
        </div>
    </div>
</div>
<?php endif; ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/settings/sections/customfields/settings/dropdown.blade.php ENDPATH**/ ?>