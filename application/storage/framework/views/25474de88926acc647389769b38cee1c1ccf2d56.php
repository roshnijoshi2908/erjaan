        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    ...
                    <a class="dropdown-item" id="invoiceDownloadButton" href="<?php echo e(url('/invoices/'.$invoice->bill_invoiceid.'/pdf')); ?>" download>
...
</script><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>