...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-9" id="knowledgebase-table-wrapper">
            ...
            <?php echo $__env->make('pages.knowledgebase.article.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--knowledgebase table-->
        </div>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/knowledgebase/wrapper-article.blade.php ENDPATH**/ ?>