        ...
        <div>
            <table class="table no-border m-b-0">
                <tbody>
                    ...
                    <tr>
                        <td class="p-l-0 p-t-5"><?php echo e(cleanLang(__('lang.expenses'))); ?></td>
                        <td class="font-medium p-r-0 p-t-5"><?php echo e(runtimeMoneyFormat($client->sum_all_expenses)); ?>
...
<!-- Column --><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/client/components/misc/leftpanel.blade.php ENDPATH**/ ?>