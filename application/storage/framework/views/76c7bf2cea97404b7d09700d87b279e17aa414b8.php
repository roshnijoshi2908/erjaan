<div class="card-description" id="card-description">
    ...
    <div class="x-content rich-text-formatting" id="card-description-container">
        <?php echo _clean($lead->lead_description); ?>
...
<!--section js resource-->
<?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/lead/components/description.blade.php ENDPATH**/ ?>