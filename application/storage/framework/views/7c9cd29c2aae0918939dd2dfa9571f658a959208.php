...
<div class="x-section x-timer m-t-10" id="task-users-task-timer">
    ...
    <span class="x-timer-time timers <?php echo e(runtimeTimerRunningStatus($task->timer_current_status)); ?>"
        id="task_timer_card_<?php echo e($task->task_id); ?>"><?php echo _clean(runtimeSecondsHumanReadable($task->my_time, false)); ?></span>
...
<?php endif; ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/task/components/timer.blade.php ENDPATH**/ ?>