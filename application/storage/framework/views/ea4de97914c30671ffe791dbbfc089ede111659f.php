<div class="card-description" id="card-description">
    ...
    <div class="x-content rich-text-formatting" id="card-description-container">
        <?php echo _clean($task->task_description); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/task/components/description.blade.php ENDPATH**/ ?>