        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <li class="nav-item dropdown d-none d-sm-block" id="topnav-reminders-dropdown"
                    ...
                    <a class="nav-link dropdown-toggle font-22 waves-dark text-danger p-t-9  <?php echo e(request('user_has_due_reminder')); ?>" href="javascript:void(0)"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php if(config('system.settings_type') == 'standalone' || in_array(config('system.settings_saas_status'), ['active', 'free-trial'])): ?>
                ...
                <li class="nav-item dropdown d-none d-sm-block" id="topnav-language-icon">
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated bounceInDown language">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <a id="language-rtl" onClick="changeDirection(<?php echo e($key); ?>)" class="dropdown-item js-ajax-request text-capitalize" href="javascript:void(0)"
...
<script>
    ...
    $('#language-rtl').on('click', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: $('#' + $(this).data('form-id')).serialize(),
            success: function(response) {
                // Check response and update body class
                if (response.success) {
                    $('body').addClass('rtl'); // Add the class
                } else {
                    $('body').removeClass('rtl'); // Remove the class
                }
            },
...
</script><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>