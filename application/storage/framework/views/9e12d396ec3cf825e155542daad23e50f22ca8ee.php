...
<tr id="payment_<?php echo e($payment->payment_id); ?>">
    ...
    <td class="payments_col_action actions_column" id="payments_col_action_<?php echo e($payment->payment_id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <!--<a href="<?php echo e(url( '/')); ?>/payments/print/<?php echo e($payment->payment_id); ?>" title="<?php echo e(cleanLang(__('lang.print'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm" target=”_blank”>
                <i style="color: black;" class="ti-export"></i>
            </a>-->
            
            <!--<button onclick="printData(<?php echo e($payment->payment_id); ?>)" title="<?php echo e(cleanLang(__('lang.print'))); ?>" class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm" target=”_blank”>
                <i style="color: black;" class="ti-export"></i>
            </button>-->
            
            <!-- Include any JavaScript libraries or frameworks you need -->
...
<!--each row-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/payments/components/table/ajax.blade.php ENDPATH**/ ?>