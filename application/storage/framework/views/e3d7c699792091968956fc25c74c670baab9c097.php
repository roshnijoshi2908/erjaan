...
<aside class="left-sidebar" id="js-trigger-nav-team"> <!--[fix] keep id as "js-trigger-nav-team"-->
    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                <?php echo _clean(config('module_menus.main_menu_client')); ?>
                ...
                <?php echo _clean(config('menus.main_menu_client')); ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/nav/leftmenu-client.blade.php ENDPATH**/ ?>