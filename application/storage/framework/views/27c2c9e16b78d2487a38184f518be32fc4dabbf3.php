    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                data-action-url="<?php echo e(url('/projects/'.$project->project_id.'/progress?ref=list')); ?>"
                data-loading-target="actionsModalBody" data-action-method="POST">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/projects/components/table/ajax.blade.php ENDPATH**/ ?>