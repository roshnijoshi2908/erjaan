    ...
    <div class="col-lg-12">
       ...
       <!-- Title -->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.lead_title'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_title" name="lead_title" placeholder=""
                       value="<?php echo e(!isset($lead->lead_title) && isset($contact_lead->lead_title) ? $contact_lead->lead_title : (isset($lead->lead_title) ? $lead->lead_title : '')); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_firstname" name="lead_firstname" placeholder=""
                       value="<?php echo e(!isset($lead->lead_firstname) && isset($contact_lead->lead_firstname) ? $contact_lead->lead_firstname : (isset($lead->lead_firstname) ? $lead->lead_firstname : '')); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_lastname" name="lead_lastname" placeholder=""
                       value="<?php echo e(!isset($lead->lead_lastname) && isset($contact_lead->lead_lastname) ? $contact_lead->lead_lastname : (isset($lead->lead_lastname) ? $lead->lead_lastname : '')); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_phone" name="lead_phone" placeholder=""
                       value="<?php echo e(!isset($lead->lead_phone) && isset($contact_lead->lead_phone) ? $contact_lead->lead_phone : (isset($lead->lead_phone) ? $lead->lead_phone : '')); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_email" name="lead_email" placeholder=""
                       value="<?php echo e(!isset($lead->lead_email) && isset($contact_lead->lead_email) ? $contact_lead->lead_email : (isset($lead->lead_email) ? $lead->lead_email : '')); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="number" class="form-control form-control-sm" id="lead_value" name="lead_value" placeholder=""
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/leads/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>