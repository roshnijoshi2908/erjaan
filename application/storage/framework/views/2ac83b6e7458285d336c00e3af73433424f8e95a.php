<div class="card count-<?php echo e(@count($purchase)); ?>" id="projects-table-wrapper">
    <div class="card-body">
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="projects-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <tbody id="projects-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.purchase.gm.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--/ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH /home2/lhxwbjte/erjaan.com/application/resources/views/pages/purchase/gm/components/table/table.blade.php ENDPATH**/ ?>