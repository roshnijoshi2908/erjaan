...
class Purchases extends Controller {
    ...
    /**
     * Export purchases to XLSX file
     * @return download
     */
    public function index(PurchasesExport $export) {

        //temp directory
        $directory = Str::random(30);

        //file name
        $filename = __('lang.purchases') . '.xlsx';
        ...
        try {
            ...
            Log::error("exporting purchase requests failed", ['process' => '[permissions]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__, 'error_message' => $error_message]);
            //default error
