...
class Leads extends Controller {
    ...
    public function indexList() {
        ...
        //get leads
        $leads = $this->leadrepo->search('',['group_by_telephone' => true]);
    ...
    public function create(CategoryRepository $categoryrepo) {
        ...
        if(request('kanban_lead_id') != null) {
    ...
    public function storeActionTaken($id)
    {
        $leads = \App\Models\Lead::findOrFail($id);
        $leads->actionTaken = request('action-taken') == "on" ? 1 : 0;
        $leads->save();
    }
}