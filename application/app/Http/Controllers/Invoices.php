...
use App\Http\Responses\Invoices\StoreInvoiceSettingResponse;
...
class Invoices extends Controller {
    ...
    public function index(ProjectRepository $projectrepo, CategoryRepository $categoryrepo) {
        ...
        //settingsInvoice
        $invoice = \App\Models\InvoiceSetting::where('user_id',auth()->id())->first();
    ...
    public function show($id) {
        ...
        //get invoice color
        $payload['invoicecolor'] = \App\Models\InvoiceSetting::where('user_id',auth()->id())->first();
    ...
    public function updateTaxType($id) {
      ...
      /**
     *  store the invoice color settings 
     * 
     * @return \Illuminate\Http\Response
     */
    public function storeInvoiceSettings(Request $request){
            $payload['invoice']= \App\Models\InvoiceSetting::updateOrCreate(['user_id' => auth()->id()],[
                'color_code' => $request->color_code,
                'text_color_code' => $request->text_color_code,
            ]);
          
        //show the form
        return new StoreInvoiceSettingResponse($payload);
    }


    public function saveInvoiceLogo(Request $request) {
        ...
        if ($file = $request->file('file')) {
            ...
            //new filepath
            $file_path = BASE_DIR . "/storage/invoice-logo/$directory/$filename";

            //create directory
            Storage::makeDirectory("invoice-logo/$directory");

            //save file to directory
            Storage::putFileAs("invoice-logo/$directory", $file, $filename);
            ...
            \App\Models\InvoiceSetting::updateOrCreate(['user_id' => auth()->id()],[
    ...
    private function pageSettings($section = '', $data = array()) {
        ...
        $page = [
            ...
            'sidepanel_setting_id' => 'sidepanel-settings-invoice',
