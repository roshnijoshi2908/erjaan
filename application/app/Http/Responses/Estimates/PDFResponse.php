...
class PDFResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('view') == 'preview') {
            ...
            return view('pages/bill/bill-pdf', compact('page', 'bill', 'taxrates', 'taxes', 'lineitems', 'elements', 'customfields', 'files', 'bodyClass', 'data','invoicecolor'))->render();
        }
        ...
        $pdf = View::make('pages/bill/bill-pdf', compact('page', 'bill', 'taxrates', 'taxes', 'lineitems', 'elements', 'customfields', 'files','bodyClass','data','invoicecolor'))->render();
