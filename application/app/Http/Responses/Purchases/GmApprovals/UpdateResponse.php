    ...
    public function toResponse($request) {
        ...
        // if (request('ref') == 'list') {
            ...
            if (auth()->user()->pref_view_projects_layout == 'list') {
                $html = view('pages/purchase/gm/components/table/ajax', compact('purchase'))->render();
                // dd($html);
                $jsondata['dom_html'][] = array(
                    'selector' => "#purchase" . $purchase->first()->purchase_id,
                    'action' => 'replace-with',
                    'value' => $html);
            }
            ...
            //update cards view
                $html = view('pages/purchase/gm/components/table/ajax', compact('purchase'))->render();
                $jsondata['dom_html'][] = array(
                    'selector' => "#purchase_" . $purchase->first()->purchase_id,
                    'action' => 'replace-with',
                    'value' => $html);
