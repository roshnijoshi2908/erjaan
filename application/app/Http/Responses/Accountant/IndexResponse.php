    ...
    public function toResponse($request)
    {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            switch (request('action')) {
                ...
                case 'load':
                    $template = 'pages/accountant/proposals/components/table/ajax';
                ...
                case 'search':
                    $template = 'pages/accountant/proposals/components/table/table';
                ...
                default:
                    $template = 'pages/accountant/proposals/tabswrapper';
            ...
            return view('pages/accountant/proposals/wrapper', compact('page', 'templates'))->render();
        }
    }
}
