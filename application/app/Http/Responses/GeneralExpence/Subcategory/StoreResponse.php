...
class StoreResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if ($count == 1) {
            $html = view('pages/generalexpence/generalexpencesubcategory/components/table/table', compact('generalexpencesubcat'))->render();
            $jsondata['dom_html'][] = array(
                'selector' => '#expencesubcat-table-wrapper',
                'action' => 'replace',
                'value' => $html);
        } else {
            ...
            $jsondata['dom_html'][] = array(
                'selector' => '#expencesubCat-td-container',
                'action' => 'prepend',
                'value' => $html);
        }
