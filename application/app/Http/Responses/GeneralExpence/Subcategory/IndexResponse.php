...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/generalexpence/generalexpencesubcategory/components/table/ajax';
                $dom_container = '#expencesubcat-td-container';
                $dom_action = 'append';
                break;
            ...
            case 'search':
                $template = 'pages/generalexpence/generalexpencesubcategory/components/table/table';
            ...
            default:
                $template = 'pages/generalexpence/generalexpencesubcategory/tabswrapper';
           ...
           /* $html = view($purchase, compact('page', 'purchase'))->render();
            ...
            //standard view
            $page['url'] = loadMoreButtonUrl($generalexpencesubcat->currentPage() + 1, request('source'));
            $page['loading_target'] = 'generalexpence-subcategory-td-container';
            $page['visibility_show_load_more'] = ($generalexpencesubcat->currentPage() < $generalexpencesubcat->lastPage()) ? true : false;
            return view('pages/generalexpence/generalexpencesubcategory/wrapper', compact('page','generalexpencesubcat'))->render();
        }
