...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/generalexpence/generalexpencecategory/components/table/ajax';
                $dom_container = '#expencecat-td-container';
                $dom_action = 'append';
                break;
            ...
            case 'search':
                $template = 'pages/generalexpence/generalexpencecategory/components/table/table';
            ...
            default:
                $template = 'pages/generalexpence/generalexpencecategory/tabswrapper';
           ...
           /* $html = view($purchase, compact('page', 'purchase'))->render();
            ...
            //standard view
            $page['url'] = loadMoreButtonUrl($generalexpencecat->currentPage() + 1, request('source'));
            $page['loading_target'] = 'generalexpence-td-container';
            $page['visibility_show_load_more'] = ($generalexpencecat->currentPage() < $generalexpencecat->lastPage()) ? true : false;
            return view('pages/generalexpence/generalexpencecategory/wrapper', compact('page','generalexpencecat'))->render();
        }
