...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/supplier/supplier/components/table/ajax';
                $dom_container = '#supplier-td-container';
                $dom_action = 'append';
                break;
            ...
            case 'search':
                $template = 'pages/supplier/supplier/components/table/table';
            ...
            if ($supplier->currentPage() < $supplier->lastPage()) {
                $url = loadMoreButtonUrl($supplier->currentPage() + 1, request('source'));
            ...
            // $html = view($supplier, compact('page', 'supplier'))->render();
            
            $html = view($template, compact('page', 'supplier'))->render();
            ...
            //standard view
            $page['url'] = loadMoreButtonUrl($supplier->currentPage() + 1, request('source'));
            $page['loading_target'] = 'supplier-td-container';
            $page['visibility_show_load_more'] = ($supplier->currentPage() < $supplier->lastPage()) ? true : false;
            return view('pages/supplier/supplier/wrapper', compact('page', 'supplier'))->render();
        }
