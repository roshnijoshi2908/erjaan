...
namespace App\Http\Responses\Suppliers\Views;
...
class ListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/suppliers/views/list/table/ajax';
            ...
            case 'search':
                $template = 'pages/suppliers/views/list/table/table';
            ...
            default:
                $template = 'pages/suppliers/views/list/tabswrapper';
            ...
            if ($suppliers->currentPage() < $suppliers->lastPage()) {
                $url = loadMoreButtonUrl($suppliers->currentPage() + 1, request('source'));
            ...
            $html = view($template, compact('page', 'suppliers', 'stats', 'categories', 'tags', 'fields'))->render();
            ...
            //standard view
            $page['url'] = loadMoreButtonUrl($suppliers->currentPage() + 1, request('source'));
            $page['loading_target'] = 'projects-td-container';
            $page['visibility_show_load_more'] = ($suppliers->currentPage() < $suppliers->lastPage()) ? true : false;
            return view('pages/suppliers/views/list/wrapper', compact('page','suppliers','tags', 'fields'))->render();
        }
