...
class CreateResponse implements Responsable {
    ...
    //     return view('pages/supplier/supplier/supplierCreate', compact('page','categories'))->render();
    // }
        ...
        //render the form
        $html = view('pages/supplier/supplier/components/modals/add-edit-inc', compact('page', 'categories'))->render();
