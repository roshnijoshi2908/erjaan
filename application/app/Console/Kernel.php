...
class Kernel extends ConsoleKernel {
    ...
    protected function schedule(Schedule $schedule) {
        ...
        //Rcurring Tasks
        $schedule->call(new \App\Cronjobs\RecurringTasksCron)->everyFiveMinutes();
        ...
        //Proposals
        $schedule->call(new \App\Cronjobs\Cleanup\OrphanedRecordsCron)->everyFiveMinutes();

        //tap payments
        $schedule->call(new \App\Cronjobs\Tap\TapPaymentCron)->everyFiveMinutes();
