...
class UserRepository {
    ...
    public function create($password = '', $returning = 'id') {
        ...
        $user->is_this_sales_person = request('is_this_sales_person');
        $user->target_revenue = request('target_revenue');
    ...
    /**
     * get all purchases accounatnt members
     * @param string $results the result return type (ids|collection)
     * @return object
     */
    public function getPurchaseAccountantUsers($results = 'collection') {

        //start query
        $query = $this->users->newQuery();
        $query->where('status', '=', 'active');
        $query->join('roles', 'users.role_id', '=', 'roles.role_id')
            ->where('roles.role_purchase_accountant', '>', 1)
            ->with(['role']);
    ...
    /**
     * get all general expence accounatnt members
     * @param string $results the result return type (ids|collection)
     * @return object
     */
    public function getGenaralExpenceAccountantUsers($results = 'collection') {

        //start query
        $query = $this->users->newQuery();
        $query->where('status', '=', 'active');
        $query->join('roles', 'users.role_id', '=', 'roles.role_id')
            ->where('roles.role_generalexpence_accountant', '>', 1)
            ->with(['role']);
    ...
    /**
     * get all purchases gm-approver members
     * @param string $results the result return type (ids|collection)
     * @return object
     */
    public function getPurchaseGmApproversUsers($results = 'collection') {

        //start query
        $query = $this->users->newQuery();
        $query->where('status', '=', 'active');
        $query->join('roles', 'users.role_id', '=', 'roles.role_id')
            ->where('roles.role_purchase_gm_approval', '>', 1)
            ->with(['role']);
    ...
    /**
     * get all general expence gm-approvers members
     * @param string $results the result return type (ids|collection)
     * @return object
     */
    public function getGenaralExpenceGmApproversUsers($results = 'collection') {

        //start query
        $query = $this->users->newQuery();
        $query->where('status', '=', 'active');
        $query->join('roles', 'users.role_id', '=', 'roles.role_id')
            ->where('roles.role_generalexpence_gm_approval', '>', 1)
            ->with(['role']);
