                ...
                <table id="template-proposal-addrow" class="table m-t-0 m-b-0 table-hover no-wrap" data-page-size="10">
                    <thead>
                        ...
                        <th class="projects_col_projects">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_project_client"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/purchase?action=sort&orderby=purchase_projectid&sortorder=asc') }}">{{ cleanLang(__('lang.project')) }}<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <th class="projects_col_supplier">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_project_client"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/purchase?action=sort&orderby=purchase_supplierid&sortorder=asc') }}">{{ cleanLang(__('lang.supplier')) }}<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>

                        <th class="projects_col_team"><a
                                href="javascript:void(0)">{{ cleanLang(__('lang.request_date')) }}</a></th>
                        <th class="projects_col_team"><a
                                href="javascript:void(0)">{{ cleanLang(__('lang.total_cost')) }}</a></th>
                        <th class="projects_col_team"><a
                                href="javascript:void(0)">{{ cleanLang(__('lang.approved_by')) }}</a></th>
                        <th class="projects_col_team"><a href="javascript:void(0)">{{ cleanLang(__('lang.paid')) }}</a>
                        </th>  <th class="projects_col_team"><a href="javascript:void(0)">{{ cleanLang(__('lang.bank')) }}</a>
                        </th>
                    ...
                    <tbody id="template-td-container">
                        <!--ajax content here-->
                        @include('pages.accountant.proposals.components.table.ajax')
                        <!--ajax content here-->
                    </tbody>
                    <tfoot>
                        <tr>
