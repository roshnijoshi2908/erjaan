<div class="row" id="js-trigger-expenses" data-client-id="{{ $expense->expense_clientid ?? '' }}"
    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label  required">{{ cleanLang(__('lang.purchase_request')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="expense_purchaseid"
                    ...
                    <option value="{{ $purchase->purchase_id }}"
                        {{ runtimePreselected($expense->expense_purchase_id ?? '', $purchase->purchase_id) }}>{{
                        runtimeLang($purchase->purchase_items_list) }} </option>
                    @endforeach
                </select>
            </div>
        </div>
