        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-action-ajax-loading-target="invoices-td-container"><i class="sl-icon-settings display-inline-block p-r-5"></i>{{ cleanLang(__('lang.recurring_settings')) }}</a>
                ...
                <a class="dropdown-item {{ runtimeVisibility('invoice-view-child-invoices', $bill->bill_recurring) }}"
                    ...
                    id="invoice-action-view-children"><i class="sl-icon-docs display-inline-block p-r-5"></i>{{ cleanLang(__('lang.view_child_invoices')) }}</a>
