...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
   ...
   @if (request()->has('filter_phone') && request('filter_phone') !== null) 
     <div id="list-page-actions">
          <a href="{{ url('/leads?toggle=layout') }}" class="list-actions-button btn btn-page-actions waves-effect waves-dark">
