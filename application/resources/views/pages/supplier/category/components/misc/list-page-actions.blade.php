...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button"
            ...
            data-url="{{ url('supplier/category/create?supplier_category_id=' . request('supplier_category_id')) }}"
            data-loading-target="commonModalBody" 
            data-modal-title="@lang('lang.add_category')"
            data-action-url="{{ url('supplier/category?supplier_category_id=' . request('supplier_category_id')) }}"
