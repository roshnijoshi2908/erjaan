...
<tr id="payment_{{ $payment->payment_id }}">
    ...
    <td class="payments_col_action actions_column" id="payments_col_action_{{ $payment->payment_id }}">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <!--<a href="{{ url( '/') }}/payments/print/{{  $payment->payment_id }}" title="{{ cleanLang(__('lang.print')) }}"
            ...
            <!--<button onclick="printData({{ $payment->payment_id }})" title="{{ cleanLang(__('lang.print')) }}" class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm" target=”_blank”>
                <i style="color: black;" class="ti-export"></i>
            </button>-->
