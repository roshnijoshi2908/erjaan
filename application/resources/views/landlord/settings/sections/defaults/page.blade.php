            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_date_format"
                        ...
                        <option value="d-m-Y"
                            {{ runtimePreselected('d-m-Y', $defaults->defaults_date_format ?? '') }}>
                            d-m-Y</option>
                        <option value="d/m/Y"
                            {{ runtimePreselected('d/m/Y', $defaults->defaults_date_format ?? '') }}>
                            d/m/Y</option>
                        <option value="m-d-Y"
                            {{ runtimePreselected('m-d-Y', $defaults->defaults_date_format ?? '') }}>
                            m-d-Y</option>
                        <option value="m/d/Y"
                            {{ runtimePreselected('m/d/Y', $defaults->defaults_date_format ?? '') }}>
                            m/d/Y</option>
                        <option value="Y-m-d"
                            {{ runtimePreselected('Y-m-d', $defaults->defaults_date_format ?? '') }}>
                            Y-m-d</option>
                        <option value="Y/m/d"
                            {{ runtimePreselected('Y/m/d', $defaults->defaults_date_format ?? '') }}>
                            Y/m/d</option>
                        <option value="Y-d-m"
                            {{ runtimePreselected('Y-d-m', $defaults->defaults_date_format ?? '') }}>
                            Y-d-m</option>
                        <option value="Y/d/m"
                            {{ runtimePreselected('Y/d/m', $defaults->defaults_date_format ?? '') }}>
                            Y/d/m</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    ...
                    <select class="select2-basic form-control form-control-sm select2-preselected"
                        ...
                        data-preselected="{{ $defaults->defaults_currency_code ?? ''}}"
