...
Route::group(['prefix' => 'invoices'], function () {
    ...
    Route::post("/invoice-settings","Invoices@storeInvoiceSettings");
    Route::post("/invoice-logo","Invoices@saveInvoiceLogo");
...
Route::group(['prefix' => 'payments'], function () {
    ...
    //Route::get('/print/{id}', "Payments@print");
});
...
Route::group(['prefix' => 'leads'], function () {
    Route::any("/group-leads", "Leads@index");
    ...
    Route::post("/{lead}/add-action-taken", "Leads@storeActionTaken")->where('lead', '[0-9]+');
...
//EXPORT PURCHAES
Route::post('export/purchase', 'Export\Purchases@index');
...
//SUPPLIERS CATEGORY
Route::resource('supplier/category','Category\Supplier');

//SUPPLIER
Route::resource('supplier','Supplier');

//purchases
Route::resource('purchase','Purchases');
Route::any("purchase/search", "Purchases@index");
Route::resource('gm-approvals','GmApprovals');
Route::get("gm-approvals/{purchase}/change-status", "GmApprovals@changeStatus")->where('gm-approvals', '[0-9]+');
Route::post("gm-approvals/{purchase}/change-status", "GmApprovals@changeStatusUpdate")->where('gm-approvals', '[0-9]+');
Route::any("gm-approvals/{client}/show-invoice", "GmApprovals@showInvoice");
Route::post("purchases/return", "Purchases@return");




Route::resource('accountant','Accounts');

// Accounts Section
Route::get("accountant_list", "Accounts@List_Purchase");

//General Expences
Route::any('general-expense', 'GeneralExpence@Index');
Route::any('general-expense/search', 'GeneralExpence@Index');
Route::any('general-expense/create', 'GeneralExpence@create');
Route::post("/general-expense", "GeneralExpence@store");
Route::get("/general-expense/{id}/edit", "GeneralExpence@edit")->where('task', '[0-9]+');
Route::put("/general-expense/{id}", "GeneralExpence@update")->where('task', '[0-9]+');
Route::delete("/general-expense/{id}", "GeneralExpence@destroy")->where('task', '[0-9]+');
Route::get('/get-subcategories/{id}', 'GeneralExpence@getSubcategories');

Route::prefix('general-expense')->group(function () {
    Route::any('category', 'GeneralExpenceCategory@Index');
    Route::any('category/create', 'GeneralExpenceCategory@create');
    Route::post("/category", "GeneralExpenceCategory@store");
    Route::get("/category/{category}/edit", "GeneralExpenceCategory@edit")->where('task', '[0-9]+');
    Route::put("/category/{category}", "GeneralExpenceCategory@update")->where('task', '[0-9]+');
    Route::delete("/category/{category}", "GeneralExpenceCategory@destroy")->where('task', '[0-9]+');
    
    Route::any('subcategory', 'GeneralExpenceSubcategory@Index');
    Route::any('subcategory/create', 'GeneralExpenceSubcategory@create');
    Route::post("/subcategory", "GeneralExpenceSubcategory@store");
    Route::get("/subcategory/{subcategory}/edit", "GeneralExpenceSubcategory@edit")->where('task', '[0-9]+');
    Route::put("/subcategory/{subcategory}", "GeneralExpenceSubcategory@update")->where('task', '[0-9]+');
    Route::delete("/subcategory/{subcategory}", "GeneralExpenceSubcategory@destroy")->where('task', '[0-9]+');
    
    Route::any('gm-approvals', 'GeneralExpenceGmApproval@Index');
    Route::get('gm-approvals/{id}/change-status', 'GeneralExpenceGmApproval@changeStatus');
    Route::post("gm-approvals/{id}/change-status", "GeneralExpenceGmApproval@changeStatusUpdate");
    
    Route::any('accountant', 'GeneralExpenceAccountant@Index');
    Route::get('accountant/{id}/edit', 'GeneralExpenceAccountant@edit');
    Route::post("accountant/{id}/update", "GeneralExpenceAccountant@update");
});
...
// Route to get to the accoutant page
// Route::get('/accoutant')