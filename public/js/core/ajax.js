...
$(document).ready(function() {
    $('.apply-setting-invoice').on('click', function() {
        var formData = new FormData();

        // Append form data
        formData.append('color_code', $('[name="color_code"]').val());
        formData.append('text_color_code', $('[name="text_color_code"]').val());
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.apply-setting-invoice').prop('disabled', true);
            },
            ...
            complete: function() {
                ...
                $('.apply-setting-invoice').prop('disabled', false);
            }
        });
    });
});
